...
def add_matrices(matrix_a, matrix_b):
    ...
    """Adds two matrices matrix_a and matrix_b of the same dimensions.
       We can iterate through each element of the matrices, add the corresponding elements, and store the result in a new matrix. 
